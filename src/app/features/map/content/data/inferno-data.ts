...
export const mapData: MapConfig = {
  ...
  strategies: [
    ...
    },
    {
      side: 'T',
      name: 'Split B',
      description: 'Esta play requiere de buena coordinación y de conteo de utilidades gastadas por los CTs. Buscamos una pinza hacia B con 3 players por mid y 2 players por banana. La fuerza de la ronda recaerá en mid, mientras que los players de B se centrarán en dispensar utilities y ganar el máximo espacio posible en banana. Se precisa de un setup en el que consigamos control de mapa general earlyround, invirtiendo utilidad de impacto en apps para denegar información y tratando de conseguir colocar a un player en boiler. El trigger se dispara cuando el segundo smoke de mid ha sido utilizado por parte de los CTs. En ese momento, buscamos jugar contra el player de larga con flashes y molotovs mayonesa, setupeando la ronda con smokes en corta y en vinos. Tras ello, la intención es correr hacia arco, aislando a los players de B, que tendrán que dividir sus esfuerzos entre parar a nuestros 2 players de banana y cerrar el site para los players de CT.',
      minimaps: ['/assets/plays/Inferno_T_SplitB.webp'],
      roles: [
        { player: 'Parca', role: 'Support + second entry', utility: 'Encargado de lanzar molotov apps early round y de generar incomodidad en mid para forzar cuanto antes el lanzamiento de smokes. Al apretar el trigger, será el encargado de smokear corta y de hacer la entry hacia larga.' },
        { player: 'Dida', role: 'Lurker', utility: 'Tras la nade mid, tratará de ganar la posición de under y, cuando el call sea dado, será la encargada de lanzar el smoke vinos y, tras 5 segundos, lanzar la popflash larga. Una vez cumplida esta labor, tendrá que alcanzar la posición de carro para molotovear triples y, si fuera posible (previo drop), flashear site al timing de la llegada de los players de mid al corredor de CT. Importante lanzar el molotov triples antes del hipotético contact del player de triples con los aliados de CT.' },
        { player: 'Kevs', role: 'Entry fragger', utility: 'Encargado de realizar la entry por mid. Junto con parca, buscará ángulos agresivos en mid y, tras el call, molotoveará la posición de mayonesa. Una vez hecho esto, la intención es correr arco, alcanzar la posición de CT y atacar site junto con Parca y Fedello. Es de suma importancia que estos players no se spliteen por iglesia. No nos interesan los duelos 1v1 en una play en la cual la principal fortaleza es la pinza. Si un CT decide jugar pasivo desde iglesia, buena suerte retakeando el segundo site más complejo de Counter Strike 2.' },
        { player: 'Peter/Kike', role: 'Entry fragger', utility: 'Principales entrys de B. Su juego earlyround se resume en una toma clásica de banana pero teniendo en cuenta que irán solos a pelearla, por lo que el peek agresivo en muro se vuelve una coinflipeada importante. El objetivo es posicionarse en el muro y jugar con la presión ejercida por los players de mid. Nades coche o sandbox pueden ser interesantes para conseguir algo de daño barato. En el momento en el que el trigger sea apretado, este player tendrá que jugar de manera inteligente con los sonidos y con los timings. No demasiado rápido como para ser el primer contact, pero tampoco demasiado lento como para no participar en el crossfire. En caso de haber un smoke banana, conviene a) pasárselo al shift buscando el salto a primeras, o b) nadearlo y buscar el duelo contra el player de coffins y/o columna. Recomendable dropear o flash o smoke al support y, en caso de querer smokear algo, JAMÁS optar por smoke CT. Siempre a coffins.' },
        { player: 'Fedello', role: 'Flank/Support', utility: 'La tarea de Fedello será buscar un aproach agresivo en apps. Su objetivo es alcanzar boiler, por lo que es recomendable usar molotov boiler para obligar a ese player a avanzar y tomar un duelo desventajoso o recular haciia corta. La flash al pasillo de apps es otra utilidad fuerte para lograr cruzar hacia las escaleras con garantías. Tras ello, esperará al call de la entry y gastará su segunda flash en corta buscando que popee medio segundo después que la de Dida. A partir de ese punto, correrá junto con Parca y Kevs dirección B site.' },
      ],
    },
    {
      side: 'CT',
